 ...
 * @param   ac          pointer to the AFEConfig
 */
static void prv_crc8_build_table(struct AFEConfig *ac);
 ...
 */
uint8_t afe_crc8_calculate(struct AFEConfig *ac, uint32_t val);
...
/**
 * [set_discharge_thres description]
 * @param  afe         [description]
 * @param  device_addr [description]
 * @param  val         [description]
 * @return             [description]
